          ...
          <div className="navbar">
            ...
            <div className="social-links">
              <a
                ...
                rel="noreferrer"
              >
                <i className="bx bxl-github" style={{ color: textColor }}></i>
              </a>
              ...
              <a
                ...
                rel="noreferrer"
              >
                <i className="ri-code-s-slash-line" style={{ color: textColor }}></i>
              </a>
              ...
              <a
                ...
                rel="noreferrer"
              >
                <i className="bx bxl-linkedin-square" style={{ color: textColor }}></i>
              </a>
            </div>
          </div>
        </nav>
